...
def plot_I3det():
    ...
    I3_dom_z = np.loadtxt("./IceCube_MasterClass_at_Harvard2025/resources/detector_info/I3_dom_zpos.txt")
    I3_str_xy = np.loadtxt("./IceCube_MasterClass_at_Harvard2025/resources/detector_info/I3_string_xypos.txt")
